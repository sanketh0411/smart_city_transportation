...
--
-- Host: localhost
-- Generation Time: Sep 11, 2024 at 01:32 PM
...
--
-- Database: `smart_city_transportation`
--
CREATE DATABASE IF NOT EXISTS `smart_city_transportation` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `smart_city_transportation`;
...
('e1gq8zy6nv4afzt69an4jlxqo1gv6vpb', 'eyJ1c2VyaWQiOjF9:1seD15:AQRdOOjg2_DzLdVKMtncWHml8LX64aKJuugvBlnTMdo', '2024-08-28 12:22:15.302003'),
...
('tqurwi3kuqnpkgsnelvbwbn41wy0in4h', 'eyJ1c2VyaWQiOjJ9:1seDey:rmhFbuNgl37P3oowq9Yi7KRlsZRpW0gnpnH3Gnklt0w', '2024-08-28 13:03:28.139182'),
...
(1, 'Gopal', 'Gopal123@gmail.com', 'Gopal', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
(2, 'Manjunath', 'tmksmanju18@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male');
...
(11, 'Random Forest Classifier', '49.504950495049506'),
(12, 'SVM', '49.17491749174918'),
(13, 'Recurrent Neural Network (RNN)', '50.495049504950494'),
(14, 'Decision Tree Classifier', '45.21452145214521'),
(15, 'Gradient Boosting Classifier', '53.135313531353134');
...
--
-- Table structure for table `remote_user_traffic_accident_detection`
--

CREATE TABLE IF NOT EXISTS `remote_user_traffic_accident_detection` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(300) NOT NULL,
  `Accident_Index` varchar(300) NOT NULL,
  `Longitude` varchar(300) NOT NULL,
  `Latitude` varchar(300) NOT NULL,
  `Police_Force` varchar(300) NOT NULL,
  `Accident_Severity` varchar(300) NOT NULL,
  `Number_of_Vehicles` varchar(300) NOT NULL,
  `Number_of_Casualties` varchar(300) NOT NULL,
  `ADate` varchar(3000) NOT NULL,
  `Day_of_Week` varchar(300) NOT NULL,
  `ATime` varchar(3000) NOT NULL,
  `first_Road_Class` varchar(300) NOT NULL,
  `first_Road_Number` varchar(300) NOT NULL,
  `Road_Type` varchar(300) NOT NULL,
  `Speed_limit` varchar(300) NOT NULL,
  `Junction_Control` varchar(300) NOT NULL,
  `second_Road_Class` varchar(300) NOT NULL,
  `second_Road_Number` varchar(300) NOT NULL,
  `Light_Conditions` varchar(300) NOT NULL,
  `Weather_Conditions` varchar(300) NOT NULL,
  `Road_Surface_Conditions` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

--
-- Dumping data for table `remote_user_traffic_accident_detection`
--

INSERT INTO `remote_user_traffic_accident_detection` (`id`, `Fid`, `Accident_Index`, `Longitude`, `Latitude`, `Police_Force`, `Accident_Severity`, `Number_of_Vehicles`, `Number_of_Casualties`, `ADate`, `Day_of_Week`, `ATime`, `first_Road_Class`, `first_Road_Number`, `Road_Type`, `Speed_limit`, `Junction_Control`, `second_Road_Class`, `second_Road_Number`, `Light_Conditions`, `Weather_Conditions`, `Road_Surface_Conditions`, `Prediction`) VALUES
(1, '10.42.0.211-52.84.37.172-59315-443-6', '202301BS00012', '-0.182872', '51.494902', '1', '3', '1', '1', '16-01-23', '1', '0:42', '3', '4', 'Single carriageway', '30', 'Automatic traffic signal', '4', '325', 'Darkness: Street lights present and lit', 'Fine without high winds', 'Dry', 'Not Severe'),
(2, '10.42.0.211-10.42.0.1-28638-53-17', '202301BS00022', '-0.174925', '51.495498', '1', '2', '1', '1', '08-01-23', '7', '3:00', '3', '4', 'Single carriageway', '30', 'Giveway or uncontrolled', '6', '0', 'Darkness: Street lights present and lit', 'Fine without high winds', 'Dry', 'Severe'),
(3, '172.217.12.174-10.42.0.42-443-36208-6', '202301BS00024', '-0.204346', '51.513039', '1', '3', '2', '1', '24-01-23', '2', '17:05', '4', '415', 'Single carriageway', '30', 'Giveway or uncontrolled', '5', '0', 'Darkness: Street lights present and lit', 'Fine without high winds', 'Dry', 'Not Severe'),
(4, '10.42.0.211-23.206.166.66-51781-80-6', '202301BS70075', '-0.177882', '51.482775', '1', '3', '1', '1', '08-03-23', '3', '13:36', '3', '3217', 'Single carriageway', '30', 'Giveway or uncontrolled', '6', '0', 'Daylight: Street light present', 'Fine without high winds', 'Dry', 'Not Severe');
