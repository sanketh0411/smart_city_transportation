"""smart_city_transportation URL Configuration
...
from smart_city_transportation import settings
...
urlpatterns = [
    ...
    url(r'^Detect_Traffic_Accident_Type/$', remoteuser.Detect_Traffic_Accident_Type, name="Detect_Traffic_Accident_Type"),
    ...
    url(r'^View_Detected_Traffic_Accident_Type_Ratio/$', serviceprovider.View_Detected_Traffic_Accident_Type_Ratio, name="View_Detected_Traffic_Accident_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Detected_Traffic_Accident_Type_Details/$', serviceprovider.View_Detected_Traffic_Accident_Type_Details, name="View_Detected_Traffic_Accident_Type_Details"),
